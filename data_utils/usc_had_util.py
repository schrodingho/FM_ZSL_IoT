...
def gen_USC_data(configs, window_size, stride):
    ...
    np.save('./data_utils/USC_data.npy', all_data)
    np.save('./data_utils/USC_label.npy', all_y_true)
    # dill.dump(all_data, open(f'data_utils/all_data.pkl', 'wb'))
    # dill.dump(all_y_true, open(f'data_utils/all_y_true.pkl', 'wb'))